      ...
      <main className="flex-grow pt-32 pb-24">
        ...
        <section className="container mx-auto px-6">
            <OwnerProfile 
                ...
                bioShort="I founded SoftBiz to challenge the status quo of what a digital agency can be. We don't just build websites; we build engines for growth."
                bioLong={`Before SoftBiz, I spent a decade leading engineering teams at top Silicon Valley startups. I saw a gap in the market for an agency that could combine high-end creative design with deep technical engineering.\n\nMy philosophy is simple: technology should serve the business, not the other way around. Every line of code we write is focused on delivering a measurable outcome for our clients.\n\nWhen I'm not coding or strategizing, you can find me hiking the trails of Northern California or tinkering with my vintage motorcycle collection.`}
