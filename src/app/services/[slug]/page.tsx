...
import {
  TechStackBadge,
  ServiceFAQs,
} from "@/components/services/ServiceInteractive";
...
const servicesData: Record<string, ServiceData> = {
  "ivr-solutions": {
    ...
    whyUs:
      "We don't drop a generic IVR template and walk away. Every flow we build is designed around your actual customer behaviour data. We obsess over first-call resolution rates and caller satisfaction scores — because that's what actually moves the needle for your business.",
    faqs: [
  ...
  "cloud-telephony": {
    ...
    whyUs:
      "We've migrated businesses off decades-old PBX hardware onto modern cloud stacks without a single dropped call during cutover. Our carrier relationships mean competitive per-minute rates and priority SLA support when you need it most.",
    faqs: [
  ...
  "call-analytics": {
    ...
    shortDesc:
      "Real-time call tracking, performance dashboards, and AI-powered insights to optimise every interaction.",
    longDesc:
    ...
    whyUs:
      "Raw call data is noise. We turn it into signal. Our analysts have worked across contact centres handling millions of calls per month, and we know exactly which metrics predict customer churn before it happens — and how to fix them.",
    faqs: [
  ...
  "missed-call-handling": {
    ...
    shortDesc:
      "Automatic callback and missed-call-to-lead systems so no business opportunity ever slips through.",
    longDesc:
    ...
    whyUs:
      "We've built missed call handling systems for businesses receiving 10,000+ missed calls a day. Our infrastructure handles burst traffic without dropping a single notification, and our CRM integrations mean leads are in your pipeline within seconds of the call ending.",
    faqs: [
  ...
  "crm-integration": {
    ...
    shortDesc:
      "Seamless two-way sync between your telephony platform and CRM for context-aware, personalised calls.",
    longDesc:
    ...
    whyUs:
      "Off-the-shelf telephony ↔ CRM connectors cover 20% of what businesses actually need. We build the other 80% — custom field mappings, complex workflow triggers, and multi-system sync that out-of-box tools simply can't handle.",
    faqs: [
  ...
  "multi-level-ivr": {
    ...
    shortDesc:
      "Advanced hierarchical call menus with NLP, adaptive routing, and intelligent self-service flows.",
    longDesc:
      "Simple press-1-for-sales menus belong in the past. Multi-level IVR systems handle complex caller journeys — account verification, appointment booking, payment collection, order status — without ever involving a human agent. We design and deploy intelligent hierarchical menu systems that use natural language processing, DTMF input, and caller history to guide every caller to the fastest, most relevant resolution.",
    icon: Zap,
    tools: [
    ...
    whyUs:
      "Building a multi-level IVR that callers actually enjoy using is genuinely hard. It requires expertise in linguistics, UX, telephony engineering, and backend integration simultaneously. We bring all four under one roof, and our designs are tested against real user behaviour — not just feature checklists.",
    faqs: [
      ...
      <main className="flex-grow pt-32 pb-20">
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-5xl mx-auto mb-20 text-center">
            <div className="inline-flex items-center justify-center p-6 bg-primary/10 rounded-3xl mb-8 text-primary">
          ...
          <div className="max-w-6xl mx-auto mb-24">
            <p className="text-center text-sm font-mono font-bold text-muted-foreground uppercase tracking-widest mb-6">
              Powered By
            </p>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 mb-32 items-start">
              <div>
                ...
                <div className="prose prose-invert prose-lg text-muted-foreground leading-loose">
                  ...
                  <p>
                    We believe in a transparency-first approach. You will never be left guessing
            ...
            <div className="mb-32">
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                  From concept to completion, we follow a rigorous workflow.
                </p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {service.process.map((step, i) => (
                  <div
                    key={i}
                    className="group p-8 rounded-3xl bg-secondary/20 border border-white/5 hover:bg-secondary/40 transition-all duration-300 hover:-translate-y-2 relative overflow-hidden"
                  >
            ...
            {/* FAQs — client component for accordion interactivity */}
            ...
            <div className="relative p-12 md:p-20 rounded-[3rem] overflow-hidden text-center bg-primary">
              ...
              <div className="relative z-10 flex flex-col items-center text-white">
                ...
                <p className="text-white/80 text-xl max-w-2xl mb-12 leading-relaxed">
                  Partner with experts who care about your results as much as you do.
                </p>
                <ServiceDirectButton
