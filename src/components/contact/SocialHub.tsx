    ...
    <section className="py-24 bg-black">
        <div className="container mx-auto px-6 text-center">
             ...
             <div className="flex justify-center gap-12">
                {[
                    { icon: Twitter, label: "Twitter", link: "https://x.com/thesoftbiz" },
                    { icon: Linkedin, label: "LinkedIn", link: "https://www.linkedin.com/company/thesoftbiz" },
                    { icon: Instagram, label: "Instagram", link: "https://www.instagram.com/thesoftbiz" },
                    { icon: Github, label: "GitHub", link: "https://github.com/thesoftbiz" },
                ].map((social, i) => (
